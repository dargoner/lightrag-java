...
class RetrievalMetricsTest(unittest.TestCase):
    ...
    def test_evaluates_hit_rates_and_recall(self):
        ...
        results = module._evaluate_retrieval(
            test_cases=[
                {"question": "q1", "relevant_doc_ids": ["doc-2", "doc-1"]},
                {"question": "q2", "relevant_doc_ids": ["doc-3"]},
            ],
            batch_results=[
                {"contexts": [{"sourceId": "doc-2:chunk-1"}, {"sourceId": "doc-9:chunk-1"}]},
                {"contexts": [{"sourceId": "doc-8:chunk-1"}, {"sourceId": "doc-3:chunk-1"}]},
            ],
        )

        self.assertEqual(results["results"][0]["matched_doc_ids"], ["doc-2", "doc-9"])
        self.assertTrue(results["results"][0]["top1_hit"])
        self.assertTrue(results["results"][0]["top3_hit"])
        self.assertAlmostEqual(results["results"][0]["recall"], 0.5, places=4)
        ...
        self.assertAlmostEqual(results["summary"]["average_recall"], 0.75, places=4)
    ...
    def test_compare_with_baseline_reports_delta(self):
        ...
        comparison = module._compare_with_baseline(
            {
                "results": [
                    {"question": "q1", "top1_hit": True, "top3_hit": True, "recall": 1.0},
                    {"question": "q2", "top1_hit": False, "top3_hit": True, "recall": 0.5},
                ],
                "summary": {"top1_hit_rate": 0.5, "top3_hit_rate": 1.0, "average_recall": 0.75},
            },
            {
                "results": [
                    {"question": "q1", "top1_hit": False, "top3_hit": True, "recall": 0.5},
                    {"question": "q2", "top1_hit": False, "top3_hit": False, "recall": 0.0},
                ],
                "summary": {"top1_hit_rate": 0.0, "top3_hit_rate": 0.5, "average_recall": 0.25},
            },
        )
...
class RetrievalOutputTest(unittest.TestCase):
    def test_writes_latest_and_baseline_payloads(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            payload = {
                "metadata": {"run_label": "candidate", "baseline_name": "sample"},
                "summary": {"top1_hit_rate": 0.5, "top3_hit_rate": 1.0, "average_recall": 0.75},
                "results": [
                    {
                        "question": "q1",
