...
class NaiveQueryStrategyTest {
    ...
    void retrievesChildVectorsButReturnsParentContext() {
        ...
        storage.vectorStore().saveAll("chunks", List.of(
            new io.github.lightragjava.storage.VectorStore.VectorRecord("chunk-parent#child:0", List.of(1.0d, 0.0d))
        ));
    ...
    void aggregatesMultipleChildMatchesIntoHigherRankedParentContext() {
        ...
        storage.vectorStore().saveAll("chunks", List.of(
            new io.github.lightragjava.storage.VectorStore.VectorRecord("chunk-parent-a#child:0", List.of(0.6d, 0.0d)),
            new io.github.lightragjava.storage.VectorStore.VectorRecord("chunk-parent-a#child:1", List.of(0.55d, 0.0d)),
            new io.github.lightragjava.storage.VectorStore.VectorRecord("chunk-parent-b#child:0", List.of(0.9d, 0.0d))
        ));
    ...
    void expandsCaptionHitsIntoAdjacentFigureContext() {
        ...
        storage.vectorStore().saveAll("chunks", List.of(
            new io.github.lightragjava.storage.VectorStore.VectorRecord("chunk-caption", List.of(1.0d, 0.0d))
        ));
